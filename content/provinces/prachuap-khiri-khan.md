...
featured: false
highlights:
  - หัวหินกับหาดยาวและตลาดโต้รุ่ง
  - ถ้ำพระยานครในอุทยานแห่งชาติเขาสามร้อยยอด
  - ทุ่งสามร้อยยอดและเส้นทางดูนก
  - เขาช่องกระจกและอ่าวมะนาวในตัวเมืองประจวบ
  - ปราณบุรีกับป่าชายเลนและหาดเงียบ
  - สวนสับปะรดและมะพร้าวตลอดสองข้างทาง
bestTime: หน้าหนาวถึงต้นร้อนทะเลใสและลมเย็น เป็นช่วงยอดนิยมที่สุด กลางฤดูฝนฝั่งอ่าวไทยยังเที่ยวได้เกือบทุกวันแต่คลื่นแรงขึ้น ส่วนถ้ำพระยานครควรไปช่วงสายที่แสงลอดลงมาพอดี
gettingThere: อยู่บนเส้นทางลงใต้ ขับรถหรือนั่งรถโดยสารจากกรุงเทพฯ ถึงหัวหินได้ในครึ่งวัน มีรถไฟสายใต้จอดหลายสถานีตั้งแต่หัวหินจนถึงบางสะพาน จังหวัดนี้ยาวมากจากเหนือจรดใต้ ควรเลือกฐานที่พักให้ตรงกับจุดที่จะเที่ยว
localFood: อาหารทะเลสดจากเรือประมงท้องถิ่น ปลาหมึกแห้ง กะปิ และน้ำปลาแท้ ของฝากขึ้นชื่อคือสับปะรดหวานและสับปะรดกวน
imageCredit:
  author: '::::=UT=::::'
...
## หัวหิน ปราณบุรี และชายฝั่งตอนบน

หัวหินเป็นเมืองตากอากาศเก่าแก่ที่ยังรักษาบรรยากาศไว้ได้ดี มีทั้งหาดยาวสำหรับเดินเล่นตอนเช้า สถานีรถไฟไม้ที่ถ่ายรูปกันไม่ขาด และตลาดกลางคืนที่ขายอาหารทะเลย่างกันทั้งถนน ถัดลงมาทางใต้คือปราณบุรีซึ่งเงียบกว่าและมีป่าชายเลนให้เดินตามสะพานไม้ ใครอยากได้หาดที่คนน้อยกว่านั้นมักเลี่ยงลงไปทางใต้ของจังหวัด ซึ่งมีแนวชายฝั่งยาวต่อเนื่อง

## เขาสามร้อยยอดและเมืองประจวบฝั่งอ่าวมะนาว

อุทยานแห่งชาติเขาสามร้อยยอดเป็นภูเขาหินปูนที่ตั้งขึ้นมาจากพื้นราบติดทะเล จุดที่คนตั้งใจไปคือถ้ำพระยานคร ซึ่งมีพระที่นั่งคูหาคฤหาสน์ตั้งอยู่กลางถ้ำและมีลำแสงส่องลงมาจากปล่องด้านบนในบางช่วงของวัน รอบอุทยานยังมีทุ่งน้ำจืดที่เป็นแหล่งดูนกสำคัญ ส่วนตัวเมืองประจวบมีอ่าวมะนาวโค้งสวยและเขาช่องกระจกที่เดินขึ้นไปมองเห็นอ่าวทั้งสามได้ในคราวเดียว

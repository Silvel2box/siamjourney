...
- [x] **Seed ที่พัก 11 แห่งให้หน้า `/hotel` ไม่โล่ง ✅ (2026-08-01) — ยังไม่ deploy**
  ...
  - 🔴 **DEPLOY: `pull → build → restart` แล้วต้อง Run script `seed:hotels` เพิ่ม 1 ตัว** (ข้อมูลอยู่ใน DB ไม่ใช่ไฟล์ — ไม่รันก็ไม่มีโรงแรมบน prod) · ไม่มี migration

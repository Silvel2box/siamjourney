...
- [x] **ติด GA4 ✅ (2026-07-31) — ยังไม่ deploy** — วัดผลจริงได้ครั้งแรกของโปรเจกต์ (ก่อนหน้านี้ไม่มี analytics เลยสักตัว)
  ...
  - **`/privacy` ไม่ต้องแก้แล้ว** — ข้อความเดิมที่เขียนว่าใช้ Google Analytics + AdSense กลายเป็น**จริง**เมื่อติด GA4 · 📌 แต่ยังค้าง: กล่อง "เอกสารนี้เป็นแบบร่างเริ่มต้น ควรให้ที่ปรึกษากฎหมายตรวจสอบ" ที่โชว์ให้คนนอกอ่าน — ควรเอาออกก่อนยื่น AdSense review (เป็นการตัดสินใจเชิงกฎหมายของ user ไม่ใช่ของ dev)
  - **DEPLOY: ไม่มี migration → pull → build → restart**

...
export default function ProvinceCard({ province }: { province: Province }) {
  ...
  return (
    ...
    >
      <div className="img-zoom-container relative h-80 md:h-[400px]">
        <Image
          src={province.image}
          alt={province.name}
          fill
      ...
      {/* Always visible: Tailwind wraps group-hover in @media (hover: hover),
          so a hover-gated summary is unreachable on touch devices. */}
      <div className="absolute bottom-0 left-0 p-8 w-full">
        ...
        <span className="text-white font-medium flex items-center gap-2 group-hover:text-primary transition">
